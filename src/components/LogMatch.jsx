...
export default function LogMatch({ players, onSubmit, onClose }) {
            ...
            {winner && loser && (
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 20, color: 'rgba(255,255,255,0.2)' }}>–</div>
                  <input
                    ...
                    style={{
                      ...
                      fontSize: 28, textAlign: 'center', outline: 'none', letterSpacing: 2,
                      MozAppearance: 'textfield',
                    }}
                  />
                </div>
                {!scoreValid && (
                  <div style={{ color: '#F4A261', fontSize: 11, marginTop: 6 }}>Loser score must be between 0 and 10</div>
                )}
